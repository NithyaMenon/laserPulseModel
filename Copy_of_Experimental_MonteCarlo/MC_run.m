...
FinalResultSet(1).TimingPerformances = [TimingPerformancesFF;TimingPerformancesRMSE];
FinalResultSet(1).PowerPerformances = calculatePowerPerformance(AllOutputData,N);
FinalResultSet(1).TimingStatistics = struct('Mean',mean([TimingPerformancesFF;TimingPerformancesRMSE],2),...
