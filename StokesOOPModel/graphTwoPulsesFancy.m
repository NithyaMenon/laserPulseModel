...
tVector1 = idealOutput(:,1)*10^9;
IVector1 = idealOutput(:,2);
IVector1(IVector1 <= 0) = 1e-12;
...
%h3=fill(tVector1,IVector1,fillcolors(4,:));
...
h3 = stairs(tVector1,IVector1,'g','LineStyle', '--','LineWidth',2);
